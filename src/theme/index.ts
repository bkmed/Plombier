...
const shadows = {
  small: {
    ...Platform.select({
      web: { boxShadow: '0px 2px 3px rgba(9, 30, 66, 0.1)' },
      default: {
        shadowColor: '#091E42',
  ...
  medium: {
    ...Platform.select({
      web: { boxShadow: '0px 8px 12px rgba(9, 30, 66, 0.15)' },
      default: {
        shadowColor: '#091E42',
  ...
  large: {
    ...Platform.select({
      web: { boxShadow: '0px 12px 16px rgba(9, 30, 66, 0.2)' },
      default: {
        shadowColor: '#091E42',
...
export const premiumTheme: Theme = {
  ...
  shadows: {
    ...
    medium: {
      ...Platform.select({
        web: { boxShadow: '0px 4px 10px rgba(255, 215, 0, 0.3)' },
        default: {
          shadowColor: '#FFD700',
